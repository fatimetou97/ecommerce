        ...
        <div class="col-md-8">
          <div class="card">
            <div class="card-body">
              ...
              <form class="forms-sample" action="{{url('/web/edit_attribute_option/'.$attribute_id.'/'.$attribute_option->id) }}" method="post">
                {{ csrf_field() }}
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label" >Attribute Option Name</label>
                    <input class="form-control"  type="text" value="{{old('name',$attribute_option->name)}}"  name="name">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <select class="form-select"  name="attribute_id">
                          ...
                          <option {{old('attribute_id',$attribute_option->attribute_id)==$attribute->id ? 'selected' :''}}
