    ...
    <div class="container-fluid py-4">
      ...
      <div class="row">
        ...
        <div class="col-12">
            ...
            <button
            onclick="location.href='{{ url('/web/add_city') }}'"
            ...
            <div class="card-body px-0 pt-0 pb-2 ">
             ...
             <tr>
                ...
                <td class="align-middle">
                 <button type="button"
                  onclick="location.href='{{ url('/web/edit_city/'.$item->id) }}'"
                  class="btn bg-gradient-info w-auto me-2">
                     <i class="bi bi-pencil-square"></i>
                </button>
              <a data-bs-toggle="modal" data-bs-target="#deletecityModal{{$item->id}}"
                title="Delete City">
                <button  class="btn bg-gradient-danger w-auto me-2"><i class="bi bi-trash"></i></button>
              </a>

                <button   type="button"
                 onclick="location.href='{{ url('/web/shipping_by_city/'.$item->id) }}'" class="btn bg-gradient-success w-auto me-2">
