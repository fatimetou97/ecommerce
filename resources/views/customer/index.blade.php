    ...
    <div class="container-fluid py-4">
      ...
      <div class="row">
        ...
        <div class="col-12">
            ...
            <button
            onclick="location.href='{{ url('/web/add_customer') }}'"
            ...
            <div class="card-body px-0 pt-0 pb-2 ">
             ...
             <tr>
                ...
                <td class="align-middle">
                 <button type="button"
                  onclick="location.href='{{ url('/web/edit_customer/'.$item->id) }}'"
                  class="btn bg-gradient-info w-auto me-2">
                     <i class="bi bi-pencil-square"></i>
                </button>
              <a data-bs-toggle="modal" data-bs-target="#deletecustomerModal{{$item->id}}"
                title="Delete customer">
                <button  class="btn bg-gradient-danger w-auto me-2"><i class="bi bi-trash"></i></button>
              </a>

                <button   type="button"
                 onclick="location.href='{{ url('/web/orders_by_customer/'.$item->id) }}'" class="btn bg-gradient-success w-auto me-2">
