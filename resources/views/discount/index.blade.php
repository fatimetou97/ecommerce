    ...
    <div class="container-fluid py-4">
      ...
      <div class="row">
        ...
        <div class="col-12">
            ...
            <button
            onclick="location.href='{{ url('/web/add_discount') }}'"
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Expired Type</th>
             ...
             <tr>
                ...
                <td>
                  <div class="d-flex px-2 py-1">
                    ...
                    <div class="d-flex flex-column justify-content-center">
                      <h6 class="mb-0 text-sm">{{$item->discount}}</h6>
                ...
                <td>
                  ...
                  <td>
                    <div class="d-flex px-2 py-1">
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="mb-0 text-sm">{{$item->expired_date}}</h6>
                ...
                <td class="align-middle">
                 <button type="button"
                  onclick="location.href='{{ url('/web/edit_discount/'.$item->id) }}'"
                  class="btn bg-gradient-info w-auto me-2">
                     <i class="bi bi-pencil-square"></i>
                </button>
              <a data-bs-toggle="modal" data-bs-target="#deletediscountModal{{$item->id}}"
