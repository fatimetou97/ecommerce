             ...
             aria-labelledby="dropdownMenuButton">
              <li class="mb-2">
                <a class="dropdown-item border-radius-md" href={{route('profile.edit')}}>
                  <div class="d-flex py-1">
                    <div class="my-auto">
                      <img src={{asset("assets/img/profile.svg")}} class="avatar avatar-sm bg-gradient-light  me-3 ">
                    </div>
              ...
              <li class="mb-2">
                ...
                <form  id='logout-form' method="POST" action="{{ route('logout') }}">
                  ...
                  <div class="d-flex py-1">
                    <div class="my-auto">
                       <img src={{asset("assets/img/logout.svg")}} class="avatar avatar-sm bg-gradient-light  me-3 ">
                    </div>
                    <div class="d-flex flex-column justify-content-center">
