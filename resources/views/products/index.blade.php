                  ...
                  <div class="d-flex px-2 py-1">
                    ...
                    <div class="d-flex flex-column justify-content-center">
                     ...
                     <span class="text-xs text-secondary mb-0">
                        <a  href="{{ url('/web/product_images/'.$item->id) }}" class="badge text-bg-dark">
                        images <i class="bi bi-images"></i></a> |
                       <a href="{{ url('/web/attributes_product/'.$item->id) }}" class="badge text-bg-light">
                        Variations <i class="bi bi-magic"></i></a>
                     </span>
                    </div>
                  </div>
                </td>
