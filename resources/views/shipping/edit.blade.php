        ...
        <div class="col-md-8">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form class="forms-sample" action="{{url('/web/edit_shipping/'.$shipping->id) }}" method="post">
                {{ csrf_field() }}
               <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                      <label for="example-text-input" class="form-control-label" >shipping Name</label>
                      <input class="form-control"  type="text" value="{{old('name',$shipping->name)}}"  name="name">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control"  type="number" value="{{old('price',$shipping->price)}}"  name="price">
                ...
                <option {{old('city_id',$shipping->city_id)==$city->id ? 'selected':''}}  value={{$city->id}}  >{{$city->name}}</option>
