    ...
    <head>
      ...
      <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
        ...
        @vite([
          ...
          'resources/assets/css/nucleo-icons.css','https://kit.fontawesome.com/42d5adcbca.js',
          'resources/assets/css/argon-dashboard.css?v=2.0.4',
          'resources/assets/css/argon-dashboard.css',
          'resources/assets/css/argon-dashboard.css.map',
...
<div class="container">
    @if (Route::has('login'))
    @auth
    <a class="navbar-brand text-white" href="{{ url('/dashboard') }}" rel="tooltip" title="Designed and Coded by Creative Tim" data-placement="bottom" target="_blank">
       Dashboard
  </a>
  ...
  <a href="{{ route('register') }}" class="btn btn-sm  bg-gradient-light mb-0 text-white">Register</a>
  @endif
  <a href="{{ route('login') }}" class="ml-4 btn btn-sm  bg-gradient-success mb-0 text-white">Login</a>
                    ...
                    <div >
                        <a href="{{ url('/dashboard') }}" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="ml-5 mt-6 text-xl font-semibold text-gray-900 dark:text-white ">
                                    Welcome to Sayercom</h2>
<br><br>
                            </div>
